...
export function MindPss10Header({
  onBack,
  current,
  total,
}: {
  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.titleRow}>
        ...
        <Text style={styles.title}>PSS-10 • Stress Check</Text>
      </View>
      ...
      <View style={styles.barPad}>
        <MindProgressBar
          current={current}
          total={total}
          trackColor={mindTheme.pssProgressTrack}
          fillColor={mindTheme.pssProgressFill}
        />
      </View>
    </View>
  );
